...
func Index(tasks []*model.Task) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!doctype html><html lang=\"en\"><head><meta charset=\"utf-8\"><title>Tasknight</title><link href=\"static/css/output.css\" rel=\"stylesheet\"><script src=\"../static/htmx.min.js\"></script><script src=\"https://unpkg.com/htmx.org/dist/ext/multi-swap.js\"></script></head><body id=\"home-body\" class=\"bg-cement\"><div id=\"home-div\" class=\"h-full w-full\"><div class=\"w-full flex flex-row gap-2 justify-end pr-4\"><h3 class=\"text-white text-lg hover:text-violet-500 hover:cursor-pointer\"><a href=\"\" hx-get=\"/login\">Login</a></h3><h3 class=\"text-white text-lg\">|</h3><h3 hx-get=\"/register\" hx-trigger=\"click\" hx-target=\"#home-div\" hx-swap=\"outerHTML\" class=\"text-white text-lg hover:text-violet-500 hover:cursor-pointer\">Register</h3></div><div class=\"h-full w-full flex flex-col items-center pt-16\">")
